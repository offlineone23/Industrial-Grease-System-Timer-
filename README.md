...
Overview:
Designed and implemented an embedded timer system for industrial grease lubrication, controlling 28 independent motors along production lines in Rolling Mill 300, Esfahan Steel Company. The system stabilizes industrial power fluctuations using recycled computer power supplies, minimizes noise, and ensures reliable operation in harsh environments.
